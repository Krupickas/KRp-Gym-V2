   Locales['cs'] = {
      ...
      ['minutes_before_exercise'] = 'minut před dalším cvičením',
      ['please_Wait'] = 'Prosím vyčkejte',
      ['already_have_rent'] = 'Už máte pujčený vozidlo',

      --spinning busy
      ['flexing_muscle'] = 'Flexiš',

      -- vstupní dialog
      ['how_long_to_flex'] = 'Jak dlouho flexit ?',
      ['description'] = 'Napište kolik sekund',
      ['choose_bike'] = 'Vyberte kolo',
      ['select_bike'] = 'Vyberte kolo které si chcete koupit',
